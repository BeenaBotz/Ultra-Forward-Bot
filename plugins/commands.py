...
main_buttons = [[
        InlineKeyboardButton('📢 Updates', url='https://t.me/CINEMACCBOTUPDATES'),
        InlineKeyboardButton('💬 Support', url='https://t.me/CINEMACCBOTDISCUSSION')
        ],[
        InlineKeyboardButton('🛠️ Help', callback_data='help'),
        InlineKeyboardButton('🩷 About', callback_data='about')
        ],[
        InlineKeyboardButton('🧑‍💻 Developer 🧑‍💻', url='https://t.me/DMWITHGOKUL')
        ]]
